...
namespace AISCM.Droid.net.azurewebsites.agc20171 {
    ...
    public partial class AISCM : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        public string update_farm_status(string temp, string mois, string raspberry_id) {
        ...
        /// <remarks/>
        public void update_farm_statusAsync(string temp, string mois, string raspberry_id) {
            this.update_farm_statusAsync(temp, mois, raspberry_id, null);
        }
        
        /// <remarks/>
        public void update_farm_statusAsync(string temp, string mois, string raspberry_id, object userState) {
